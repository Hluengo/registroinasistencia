          ...
          {isEditing ? (
            <form onSubmit={handleSubmitEdit(onUpdate)} className="space-y-6">
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  >
                    {getAbsenceStatusLabel(
                      selectedAbsence.status || 'PENDIENTE'
                    )}
                  </Badge>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label
                  htmlFor="edit-absence-observation"
              ...
              <div className="space-y-2">
                ...
                {selectedAbsence.document_url && !file && (
                  <p className="text-xs text-slate-400 italic">
                    Ya existe un documento cargado. Subir uno nuevo lo
                    reemplazará.
                  </p>
                )}
              </div>
