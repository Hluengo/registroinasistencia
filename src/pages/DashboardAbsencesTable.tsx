  ...
  return (
    <div className="card overflow-hidden border border-slate-200/60 shadow-sm shadow-slate-200/20 rounded-3xl">
      <div className="px-8 py-6 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
        ...
        <Badge
          variant="secondary"
          className="bg-slate-100 text-slate-500 font-bold px-3 py-1"
        >
          {absences.length} registros
        </Badge>
      </div>
                      ...
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {abs.document_url && (
                          <Button
                            ...
                            icon={Download}
                            onClick={() =>
                              window.open(abs.document_url!, '_blank')
                            }
                      ...
                      <td colSpan={6} className="px-6 py-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                          {abs.affected_tests?.map((test: Test) => (
                            <div
                              key={test.id}
                              className="bg-white p-4 rounded-2xl border border-rose-100 shadow-sm shadow-rose-500/5"
                            >
